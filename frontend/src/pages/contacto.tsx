                        ...
                        <div>
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex space-x-4 justify-center lg:justify-start">
                                    ...
                                    <a
                                        href="https://www.tiktok.com/@eficorp.accounting?_r=1&_t=ZS-93mddTMu0Fp" target="_blank"
                                        className="w-12 h-12 bg-black hover:bg-zinc-900 rounded-lg flex items-center justify-center transition-all shadow-md hover:shadow-lg"
                                        aria-label="TikTok"
                                    >
                                        <svg
                                            viewBox="0 0 24 24"
